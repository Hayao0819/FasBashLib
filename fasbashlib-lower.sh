...
FSBLIB_FUNCLIST+=("LibreTranslate.check" "SrcInfo.format" "LibreTranslate.languages" "SrcInfo.getPkgBase" "LibreTranslate.translate" "SrcInfo.getValueInPkgName" "parseArg" "SrcInfo.getValue" "SrcInfo.getPkgName" "SrcInfo.getSectionList" "SrcInfo.getValueInPkgBase" "LibreTranslate.detect" "SrcInfo.getKeyList" "SrcInfo.parse" "LibreTranslate.translateAuto" "choice" "choiceLoop" "addNewToArray" "arrayAppend" "arrayIncludes" "arrayIndex" "getArrayIndex" "printArray" "revArray" "strToCharList" "printEvalArray" "Msg.common" "Msg.debug" "Msg.info" "Msg.warn" "Pm.getConfig" "Pm.getInstalledPkgVer" "Pm.getKeyringList" "Pm.getLatestPkgVer" "Pm.getName" "Pm.getPacmanKernelPkg" "Pm.getPacmanKeyringDir" "Pm.getRepoConf" "Pm.getRepoListFromConf" "Pm.getRepoServer" "Pm.getRepoPkgList" "Pm.isRepoPkg" "Pm.getRepoVer" "Pm.run" "Msg.err" "Pm.checkPkg" "Pm.runKey" "Ini.getLastParam" "Ini.getParam" "Ini.getParamList" "Ini.getSectionList" "Pm.pacmanGpg" "Pm.getRoot" "Cache.exist" "Arch.getKernelFileList" "Cache.get" "Arch.getKernelSrcList" "Cache.getDir" "Arch.getMkinitcpioPresetList" "Cache.getTimeDiffFromLastUpdate" "Csv.getClm" "Csv.getClmCnt" "Csv.toBashArray" "Fsblib.envCheck" "Awk.cos" "Fsblib.requireLib" "Awk.print" "Awk.tan" "Cache.getFileLastUpdate" "Ini.parseLine" "Awk.log" "Awk.pi" "Misskey.notes.Create" "Misskey.notes.Renotes" "Fsblib.fsblibEnvCheck" "Misskey.notes.Search" "Cache.getID" "URL.fragment" "URL.authority" "URL.host" "URL.query" "URL.pathAndQueryAndFragment" "URL.scheme" "URL.port" "URL.user" "Awk.rad" "Awk.sin" "Awk.float" "URL.path" "URL.noScheme" "Sqlite3.call" "Sqlite3.delete" "Sqlite3.connect" "Sqlite3.existField" "Sqlite3.create" "Sqlite3.currentDb" "Sqlite3.existTable" "Sqlite3.selectAll" "Sqlite3.insert" "Sqlite3.select" "readlinkf" "readlinkf_Posix" "readlinkf_Readlink" "Em.getDefaultRepoName" "Em.getInstalledPkgList" "Em.getRepoConf" "Em.getRepoLocation" "Em.getRepoPkgList" "Em.getWorldPkgList" "Em.getAllPkgList" "fileType" "getBaseName" "getFileExt" "removeFileExt" "Array.append" "Array.pop" "Array.remove" "Array.push" "Array.shift" "Array.fromStr" "Array.rev" "Cache.create" "Pm.getDbSectionList" "Cache.createDir" "Pm.getDbNextSection" "Pm.getDbSection" "Em.noVersion" "URL.hasAuthority" "URL.hasPort" "URL.hasUser" "URL.hasFragment" "URL.hasQuery" "Ini.newSection" "Misskey.users.GetFrequentlyRepliedUsers" "Ini.setValue" "Misskey.users.Pages" "Misskey.users.SearchByUsernameAndHost" "Misskey.users.Show" "Misskey.users.Notes" "Ini.newParam" "Misskey.users.Stats" "checkFuncDefined" "forEach" "getLine" "isAvailable" "loop" "Array.eval" "Array.last" "Array.print" "URL.parse" "Pm.getSyncAllDesc" "Pm.getRepoListFromLocalDb" "Pm.createDbTmpDir" "Pm.getPkgArch" "Pm.deleteDbTmpDir" "Pm.isOpendSyncDb" "Pm.openedSyncDbList" "Pm.getVirtualPkgList" "Pm.parsePkgFileName" "Pm.getSyncDbDesc" "Pm.getSyncDbDescPath" "Pm.openSyncDb" "Pm.getDbTmpDir" "Misskey.admin.ServerInfo" "breakChar" "cutLastString" "getLastSplitString" "isUUID" "printEval" "randomString" "removeBlank" "textBox" "toLower" "toLowerStdin" "URL.getQuery" "URL.parseQuery" "Array.indexOf" "Array.length" "Array.lastIndex" "sum" "calcInt" "ntest" "Misskey.setup" "bool" "Array.forEach" "Array.includes" "Misskey.i" "Misskey.meta" "Misskey.serverInfo" "getFuncList" "unsetAllFunc" "removeMatchLine" "Misskey.sendReq" "match" "Misskey.makeJson" "Misskey.bindingBase" "Misskey.myUserName" "Misskey.myName" "Misskey.isAdmin" "Misskey.myId")
declare -r FSBLIB_VERSION='v0.2.6.r376.gee38dd7-lower'
