...
FSBLIB_FUNCLIST+=("addNewToArray" "arrayAppend" "arrayIncludes" "printArray" "arrayIndex" "getArrayIndex" "printEvalArray" "strToCharList" "revArray" "Sqlite3.call" "Sqlite3.connect" "Sqlite3.currentDb" "Sqlite3.existField" "Sqlite3.insert" "Sqlite3.delete" "Sqlite3.select" "Sqlite3.create" "Msg.err" "Msg.info" "Sqlite3.selectAll" "SrcInfo.format" "SrcInfo.getKeyList" "SrcInfo.getSectionList" "SrcInfo.getValue" "Msg.warn" "Sqlite3.existTable" "SrcInfo.getValueInPkgBase" "Msg.debug" "SrcInfo.getPkgBase" "SrcInfo.getPkgName" "Array.append" "SrcInfo.parse" "Array.fromStr" "Array.pop" "Msg.common" "SrcInfo.getValueInPkgName" "Array.push" "Array.shift" "Array.rev" "Array.remove" "readlinkf" "readlinkf_Posix" "readlinkf_Readlink" "Fsblib.envCheck" "Fsblib.fsblibEnvCheck" "Fsblib.requireLib" "Cache.exist" "Cache.getDir" "Cache.getID" "Cache.getTimeDiffFromLastUpdate" "Ini.getParam" "Ini.getParamList" "Ini.getSectionList" "Ini.parseLine" "Pm.isRepoPkg" "Pm.run" "Pm.getLatestPkgVer" "Pm.getName" "Pm.getPacmanKernelPkg" "Pm.getPacmanKeyringDir" "Pm.getRepoConf" "Pm.getRepoListFromConf" "Pm.getRepoPkgList" "Pm.getRepoServer" "Pm.getRepoVer" "Pm.getRoot" "Cache.getFileLastUpdate" "Cache.get" "Pm.pacmanGpg" "Pm.checkPkg" "Pm.getConfig" "Pm.getInstalledPkgVer" "Pm.getKeyringList" "parseArg" "choice" "URL.scheme" "URL.query" "URL.port" "URL.pathAndQueryAndFragment" "URL.user" "URL.path" "Awk.sin" "Awk.log" "URL.host" "URL.noScheme" "URL.fragment" "URL.authority" "Awk.print" "Awk.cos" "Awk.rad" "Awk.tan" "Ini.getLastParam" "Awk.pi" "Csv.toBashArray" "Csv.getClm" "Pm.runKey" "choiceLoop" "Awk.float" "Csv.getClmCnt" "Em.getAllPkgList" "Em.getDefaultRepoName" "Em.getInstalledPkgList" "Em.getRepoConf" "Em.getRepoPkgList" "Em.getWorldPkgList" "Em.getRepoLocation" "Arch.getKernelFileList" "Arch.getKernelSrcList" "Arch.getMkinitcpioPresetList" "getBaseName" "removeFileExt" "Misskey.notes.Renotes" "getFileExt" "Misskey.notes.Search" "fileType" "Misskey.notes.Create" "Array.eval" "Array.last" "Array.print" "URL.hasFragment" "URL.hasPort" "URL.hasQuery" "URL.hasUser" "URL.hasAuthority" "Cache.create" "Cache.createDir" "Pm.getDbNextSection" "Pm.getDbSection" "Pm.getDbSectionList" "Ini.newSection" "Ini.newParam" "Ini.setValue" "Em.noVersion" "isAvailable" "loop" "checkFuncDefined" "forEach" "getLine" "Misskey.users.Notes" "Misskey.users.Stats" "Misskey.users.Pages" "Misskey.users.Show" "Misskey.users.SearchByUsernameAndHost" "Misskey.users.GetFrequentlyRepliedUsers" "Array.indexOf" "Array.lastIndex" "Array.length" "URL.parse" "Pm.deleteDbTmpDir" "Pm.getDbTmpDir" "Pm.getRepoListFromLocalDb" "Pm.getSyncAllDesc" "Pm.getSyncDbDescPath" "Pm.getSyncDbDesc" "Pm.createDbTmpDir" "Pm.getPkgArch" "Pm.getVirtualPkgList" "Pm.openSyncDb" "Pm.openedSyncDbList" "Pm.parsePkgFileName" "Pm.isOpendSyncDb" "breakChar" "randomString" "toLowerStdin" "getLastSplitString" "removeBlank" "isUUID" "printEval" "toLower" "cutLastString" "textBox" "Misskey.admin.ServerInfo" "Array.forEach" "Array.includes" "URL.parseQuery" "URL.getQuery" "calcInt" "ntest" "sum" "Misskey.setup" "Misskey.i" "Misskey.meta" "Misskey.serverInfo" "bool" "Misskey.sendReq" "Misskey.makeJson" "Misskey.bindingBase" "getFuncList" "unsetAllFunc" "Misskey.myId" "Misskey.isAdmin" "removeMatchLine" "Misskey.myUserName" "Misskey.myName" "match")
declare -r FSBLIB_VERSION='v0.2.5.1.r421.gece24c1-lower'
