...
declare -r FSBLIB_FUNCLIST=("parseArg" "Misskey.notes.Create" "Misskey.notes.Renotes" "Misskey.notes.Search" "Cache.exist" "Cache.get" "Cache.getFileLastUpdate" "Cache.getTimeDiffFromLastUpdate" "addNewToArray" "arrayAppend" "arrayIncludes" "Cache.getID" "Cache.getDir" "arrayIndex" "revArray" "Arch.getKernelSrcList" "strToCharList" "Arch.getMkinitcpioPresetList" "printEvalArray" "printArray" "getArrayIndex" "Arch.getKernelFileList" "URL.path" "URL.scheme" "URL.fragment" "URL.host" "URL.noScheme" "URL.pathAndQueryAndFragment" "URL.port" "URL.user" "URL.query" "Array.append" "Array.fromStr" "Array.pop" "Array.push" "Array.remove" "URL.authority" "Ini.getParamList" "Ini.getSectionList" "Ini.parseLine" "SrcInfo.format" "SrcInfo.getKeyList" "SrcInfo.getPkgBase" "SrcInfo.getPkgName" "SrcInfo.getSectionList" "Pm.run" "SrcInfo.getValue" "SrcInfo.getValueInPkgBase" "Pm.pacmanGpg" "Pm.runKey" "SrcInfo.getValueInPkgName" "Sqlite3.select" "Ini.getLastParam" "Array.rev" "Ini.getParam" "choice" "readlinkf" "readlinkf_Posix" "readlinkf_Readlink" "Sqlite3.call" "Sqlite3.connect" "Sqlite3.create" "Sqlite3.delete" "Sqlite3.existField" "Sqlite3.existTable" "Sqlite3.insert" "Pm.getKeyringList" "Csv.getClm" "Sqlite3.currentDb" "Pm.checkPkg" "Pm.getName" "Pm.getPacmanKernelPkg" "Pm.getPacmanKeyringDir" "Pm.getRepoListFromConf" "Pm.getRepoVer" "Array.shift" "Csv.toBashArray" "Pm.getConfig" "Pm.getRepoConf" "Pm.getRoot" "Sqlite3.selectAll" "Csv.getClmCnt" "Awk.rad" "Pm.getRepoServer" "Awk.sin" "Pm.getLatestPkgVer" "SrcInfo.parse" "Awk.float" "Awk.log" "Awk.pi" "Awk.print" "Pm.isRepoPkg" "Pm.getInstalledPkgVer" "Pm.getRepoPkgList" "Awk.tan" "Awk.cos" "Msg.common" "Msg.debug" "Msg.err" "Msg.info" "Msg.warn" "Em.getAllPkgList" "Em.getDefaultRepoName" "Em.getRepoConf" "Em.getRepoLocation" "Em.getRepoPkgList" "Em.getWorldPkgList" "Fsblib.fsblibEnvCheck" "Em.getInstalledPkgList" "Cache.createDir" "Fsblib.envCheck" "Cache.create" "Fsblib.requireLib" "Misskey.users.GetFrequentlyRepliedUsers" "Misskey.users.Pages" "Misskey.users.SearchByUsernameAndHost" "Misskey.users.Show" "Misskey.users.Notes" "Misskey.users.Stats" "getBaseName" "Array.last" "URL.hasFragment" "URL.hasPort" "Array.print" "getFileExt" "fileType" "Array.eval" "URL.hasAuthority" "removeFileExt" "URL.hasUser" "Pm.getDbSection" "Pm.getDbSectionList" "Ini.newParam" "Ini.newSection" "URL.hasQuery" "Pm.getDbNextSection" "Ini.setValue" "Em.noVersion" "Misskey.admin.ServerInfo" "Array.lastIndex" "loop" "checkFuncDefined" "forEach" "Array.indexOf" "Array.length" "isAvailable" "getLine" "URL.parse" "Pm.parsePkgFileName" "Pm.getSyncAllDesc" "Pm.getSyncDbDesc" "Pm.getRepoListFromLocalDb" "Pm.getDbTmpDir" "Pm.getSyncDbDescPath" "Pm.getVirtualPkgList" "Pm.isOpendSyncDb" "Pm.deleteDbTmpDir" "Pm.openedSyncDbList" "Pm.openSyncDb" "Pm.getPkgArch" "Pm.createDbTmpDir" "Misskey.setup" "Array.forEach" "Array.includes" "randomString" "toLowerStdin" "toLower" "getLastSplitString" "breakChar" "isUUID" "removeBlank" "cutLastString" "printEval" "textBox" "URL.getQuery" "URL.parseQuery" "Misskey.meta" "Misskey.serverInfo" "Misskey.i" "calcInt" "ntest" "sum" "Misskey.makeJson" "Misskey.sendReq" "Misskey.bindingBase" "bool" "Misskey.myName" "Misskey.isAdmin" "Misskey.myUserName" "Misskey.myId" "getFuncList" "unsetAllFunc" "removeMatchLine" "match")
