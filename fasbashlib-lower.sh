...
declare -r FSBLIB_FUNCLIST=("Arch.getMkinitcpioPresetList" "Arch.getKernelSrcList" "Arch.getKernelFileList" "Csv.getClm" "Csv.getClmCnt" "Csv.toBashArray" "choice" "parseArg" "Msg.err" "Msg.debug" "Msg.info" "readlinkf" "readlinkf_Posix" "Awk.float" "readlinkf_Readlink" "Awk.log" "Msg.warn" "Awk.pi" "Awk.cos" "Msg.common" "Awk.print" "Awk.rad" "Sqlite3.call" "Sqlite3.connect" "Awk.tan" "Sqlite3.create" "Sqlite3.currentDb" "Sqlite3.existTable" "Awk.sin" "Sqlite3.select" "Sqlite3.selectAll" "Sqlite3.insert" "Misskey.notes.Create" "Misskey.notes.Renotes" "Sqlite3.delete" "Sqlite3.existField" "Misskey.notes.Search" "Pm.checkPkg" "Pm.getInstalledPkgVer" "Pm.getKeyringList" "Pm.getPacmanKeyringDir" "Pm.getLatestPkgVer" "Pm.getRepoListFromConf" "Pm.getRepoServer" "Pm.getRepoVer" "Pm.getRepoConf" "Pm.getRoot" "Pm.isRepoPkg" "Pm.pacmanGpg" "Pm.run" "Pm.runKey" "Pm.getPacmanKernelPkg" "Pm.getConfig" "Pm.getName" "Pm.getRepoPkgList" "Em.getWorldPkgList" "Em.getDefaultRepoName" "Em.getInstalledPkgList" "Em.getRepoConf" "Em.getRepoLocation" "Em.getRepoPkgList" "Em.getAllPkgList" "URL.query" "Ini.getLastParam" "Ini.getParam" "Ini.getParamList" "Ini.getSectionList" "Ini.parseLine" "Array.append" "Array.shift" "URL.authority" "URL.host" "URL.noScheme" "URL.path" "URL.pathAndQueryAndFragment" "URL.port" "SrcInfo.getPkgName" "URL.fragment" "SrcInfo.getValue" "SrcInfo.format" "Cache.exist" "SrcInfo.getValueInPkgName" "SrcInfo.parse" "Cache.getDir" "Cache.getID" "URL.user" "Cache.getFileLastUpdate" "Array.fromStr" "Array.pop" "Array.push" "Array.remove" "Array.rev" "Cache.getTimeDiffFromLastUpdate" "Cache.get" "URL.scheme" "SrcInfo.getPkgBase" "SrcInfo.getKeyList" "Fsblib.envCheck" "Fsblib.fsblibEnvCheck" "Fsblib.requireLib" "SrcInfo.getValueInPkgBase" "SrcInfo.getSectionList" "addNewToArray" "arrayIncludes" "arrayIndex" "getArrayIndex" "printEvalArray" "strToCharList" "arrayAppend" "revArray" "printArray" "Misskey.users.GetFrequentlyRepliedUsers" "Misskey.users.Stats" "Misskey.users.Notes" "Misskey.users.Show" "Misskey.users.Pages" "Misskey.users.SearchByUsernameAndHost" "Pm.getDbSection" "Pm.getDbNextSection" "Pm.getDbSectionList" "Ini.newParam" "Em.noVersion" "Ini.newSection" "Ini.setValue" "Array.last" "Array.print" "Cache.create" "Cache.createDir" "Array.eval" "URL.hasQuery" "URL.hasUser" "URL.hasAuthority" "URL.hasFragment" "URL.hasPort" "fileType" "getBaseName" "getFileExt" "removeFileExt" "Misskey.admin.ServerInfo" "Pm.getSyncAllDesc" "Pm.isOpendSyncDb" "Pm.getSyncDbDesc" "Pm.getVirtualPkgList" "Pm.openedSyncDbList" "Pm.deleteDbTmpDir" "Pm.getSyncDbDescPath" "Pm.parsePkgFileName" "Pm.getPkgArch" "Pm.createDbTmpDir" "Pm.getDbTmpDir" "Pm.openSyncDb" "Pm.getRepoListFromLocalDb" "Array.indexOf" "Array.lastIndex" "Array.length" "URL.parse" "getLine" "isAvailable" "loop" "checkFuncDefined" "forEach" "Misskey.setup" "Array.includes" "URL.getQuery" "URL.parseQuery" "Array.forEach" "toLower" "breakChar" "cutLastString" "isUUID" "printEval" "randomString" "textBox" "removeBlank" "toLowerStdin" "getLastSplitString" "Misskey.meta" "Misskey.i" "Misskey.serverInfo" "ntest" "sum" "calcInt" "Misskey.bindingBase" "Misskey.makeJson" "Misskey.sendReq" "bool" "Misskey.myName" "Misskey.myUserName" "Misskey.myId" "Misskey.isAdmin" "getFuncList" "unsetAllFunc" "removeMatchLine" "match")
declare -r FSBLIB_VERSION='v0.2.5.1.r350.ge2a54d4-lower'
