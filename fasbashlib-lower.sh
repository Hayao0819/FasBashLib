...
declare -r FSBLIB_FUNCLIST=("parseArg" "Csv.getClm" "Csv.getClmCnt" "Cache.get" "Csv.toBashArray" "Cache.exist" "Cache.getDir" "Cache.getFileLastUpdate" "Cache.getTimeDiffFromLastUpdate" "Cache.getID" "Sqlite3.call" "Sqlite3.create" "Sqlite3.currentDb" "Sqlite3.delete" "Sqlite3.existField" "Sqlite3.existTable" "Sqlite3.insert" "Sqlite3.selectAll" "Arch.getKernelFileList" "Arch.getMkinitcpioPresetList" "Sqlite3.select" "Sqlite3.connect" "Arch.getKernelSrcList" "URL.authority" "URL.fragment" "URL.user" "URL.host" "URL.noScheme" "URL.path" "URL.port" "URL.query" "URL.scheme" "arrayAppend" "getArrayIndex" "printArray" "printEvalArray" "strToCharList" "choice" "arrayIncludes" "revArray" "URL.pathAndQueryAndFragment" "addNewToArray" "arrayIndex" "Misskey.notes.Create" "Misskey.notes.Renotes" "Misskey.notes.Search" "Msg.err" "Msg.common" "Msg.info" "Msg.warn" "Array.fromStr" "Array.pop" "Array.push" "Array.remove" "Array.rev" "Array.shift" "Msg.debug" "Array.append" "Fsblib.envCheck" "Fsblib.fsblibEnvCheck" "Fsblib.requireLib" "Awk.float" "Awk.cos" "Awk.rad" "Awk.tan" "Pm.getConfig" "Pm.getKeyringList" "Pm.getLatestPkgVer" "Pm.getName" "Pm.runKey" "Pm.checkPkg" "Awk.sin" "Pm.getInstalledPkgVer" "Pm.run" "Pm.pacmanGpg" "Pm.isRepoPkg" "Pm.getRepoVer" "Pm.getRepoServer" "Pm.getRepoPkgList" "Pm.getRepoListFromConf" "Pm.getPacmanKernelPkg" "Awk.pi" "readlinkf_Posix" "readlinkf_Readlink" "SrcInfo.format" "SrcInfo.parse" "SrcInfo.getPkgBase" "Pm.getRoot" "Pm.getPacmanKeyringDir" "SrcInfo.getSectionList" "SrcInfo.getValue" "SrcInfo.getKeyList" "Pm.getRepoConf" "Awk.print" "Ini.getParam" "Ini.getParamList" "Ini.getSectionList" "SrcInfo.getValueInPkgBase" "Awk.log" "Ini.parseLine" "readlinkf" "Ini.getLastParam" "SrcInfo.getValueInPkgName" "SrcInfo.getPkgName" "Em.getWorldPkgList" "Em.getAllPkgList" "Em.getDefaultRepoName" "Em.getRepoLocation" "Em.getInstalledPkgList" "Em.getRepoPkgList" "Em.getRepoConf" "Cache.create" "Cache.createDir" "getBaseName" "getFileExt" "removeFileExt" "fileType" "Misskey.users.GetFrequentlyRepliedUsers" "Misskey.users.Notes" "Misskey.users.Pages" "URL.hasAuthority" "Misskey.users.Show" "URL.hasFragment" "Misskey.users.Stats" "URL.hasQuery" "URL.hasUser" "Misskey.users.SearchByUsernameAndHost" "URL.hasPort" "Array.print" "Array.eval" "Array.last" "Ini.newParam" "Ini.newSection" "Ini.setValue" "Pm.getDbSection" "Pm.getDbSectionList" "Pm.getDbNextSection" "Em.noVersion" "forEach" "isAvailable" "loop" "checkFuncDefined" "getLine" "Misskey.admin.ServerInfo" "Array.lastIndex" "Array.length" "Array.indexOf" "URL.parse" "Pm.deleteDbTmpDir" "Pm.getSyncDbDesc" "Pm.getRepoListFromLocalDb" "Pm.createDbTmpDir" "Pm.getVirtualPkgList" "Pm.getSyncAllDesc" "Pm.getDbTmpDir" "Pm.openSyncDb" "Pm.parsePkgFileName" "Pm.getPkgArch" "Pm.openedSyncDbList" "Pm.getSyncDbDescPath" "Pm.isOpendSyncDb" "breakChar" "cutLastString" "printEval" "randomString" "removeBlank" "isUUID" "toLower" "getLastSplitString" "textBox" "toLowerStdin" "Array.forEach" "Array.includes" "Misskey.setup" "URL.parseQuery" "URL.getQuery" "ntest" "calcInt" "sum" "Misskey.meta" "Misskey.serverInfo" "Misskey.i" "bool" "Misskey.makeJson" "Misskey.sendReq" "Misskey.bindingBase" "getFuncList" "unsetAllFunc" "Misskey.myName" "Misskey.myId" "Misskey.myUserName" "Misskey.isAdmin" "removeMatchLine" "match")
declare -r FSBLIB_VERSION='v0.2.5.1.r347.g9741c8d-lower'
