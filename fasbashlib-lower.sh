...
declare -r FSBLIB_FUNCLIST=("Arch.getKernelFileList" "Em.getAllPkgList" "Arch.getKernelSrcList" "Em.getRepoPkgList" "Arch.getMkinitcpioPresetList" "Em.getDefaultRepoName" "Em.getRepoConf" "Em.getRepoLocation" "Em.getWorldPkgList" "Em.getInstalledPkgList" "parseArg" "Misskey.notes.Renotes" "Misskey.notes.Search" "Misskey.notes.Create" "Awk.cos" "Awk.float" "Awk.log" "Awk.pi" "Awk.print" "choice" "Awk.rad" "Awk.tan" "Pm.getConfig" "Pm.getInstalledPkgVer" "Pm.getLatestPkgVer" "Pm.getPacmanKernelPkg" "Pm.getRepoListFromConf" "Pm.getRepoConf" "Awk.sin" "Pm.run" "Pm.getPacmanKeyringDir" "Pm.pacmanGpg" "Cache.get" "Cache.getDir" "Pm.checkPkg" "Cache.getID" "Pm.getRepoPkgList" "Pm.isRepoPkg" "Pm.runKey" "Ini.getParamList" "Ini.getParam" "Pm.getKeyringList" "Cache.getFileLastUpdate" "Pm.getRoot" "Pm.getRepoServer" "Pm.getName" "Pm.getRepoVer" "Msg.common" "Msg.err" "Msg.info" "Cache.exist" "Msg.warn" "Cache.getTimeDiffFromLastUpdate" "Ini.getLastParam" "Ini.parseLine" "Csv.toBashArray" "Csv.getClmCnt" "Csv.getClm" "Ini.getSectionList" "Msg.debug" "Fsblib.requireLib" "Fsblib.fsblibEnvCheck" "URL.fragment" "URL.host" "URL.noScheme" "URL.path" "URL.pathAndQueryAndFragment" "URL.port" "URL.query" "URL.user" "URL.authority" "readlinkf" "readlinkf_Posix" "Fsblib.envCheck" "URL.scheme" "readlinkf_Readlink" "SrcInfo.format" "SrcInfo.getPkgBase" "SrcInfo.getPkgName" "SrcInfo.getValue" "SrcInfo.getValueInPkgBase" "SrcInfo.getValueInPkgName" "SrcInfo.parse" "SrcInfo.getKeyList" "SrcInfo.getSectionList" "Array.push" "Array.remove" "Array.pop" "Array.shift" "Array.rev" "Sqlite3.call" "Sqlite3.create" "Sqlite3.currentDb" "Sqlite3.delete" "Sqlite3.existTable" "Sqlite3.insert" "Sqlite3.select" "Array.fromStr" "Array.append" "Sqlite3.connect" "Sqlite3.existField" "Sqlite3.selectAll" "arrayAppend" "arrayIndex" "printArray" "revArray" "strToCharList" "printEvalArray" "arrayIncludes" "addNewToArray" "getArrayIndex" "Em.noVersion" "Misskey.users.Stats" "Misskey.users.Pages" "Misskey.users.GetFrequentlyRepliedUsers" "Misskey.users.Notes" "Misskey.users.Show" "Misskey.users.SearchByUsernameAndHost" "Pm.getDbSection" "Pm.getDbNextSection" "Pm.getDbSectionList" "Cache.createDir" "URL.hasAuthority" "URL.hasUser" "URL.hasFragment" "URL.hasPort" "Cache.create" "URL.hasQuery" "Ini.setValue" "Ini.newSection" "Ini.newParam" "fileType" "getBaseName" "getFileExt" "removeFileExt" "Array.eval" "Array.last" "Array.print" "Misskey.admin.ServerInfo" "Pm.getVirtualPkgList" "Pm.deleteDbTmpDir" "Pm.isOpendSyncDb" "Pm.getPkgArch" "Pm.openSyncDb" "Pm.getSyncDbDesc" "Pm.openedSyncDbList" "Pm.getSyncDbDescPath" "Pm.createDbTmpDir" "Pm.parsePkgFileName" "URL.parse" "Pm.getRepoListFromLocalDb" "Pm.getSyncAllDesc" "Pm.getDbTmpDir" "checkFuncDefined" "getLine" "isAvailable" "forEach" "Array.indexOf" "Array.length" "loop" "Array.lastIndex" "Misskey.setup" "URL.parseQuery" "URL.getQuery" "isUUID" "printEval" "randomString" "getLastSplitString" "removeBlank" "toLower" "textBox" "breakChar" "cutLastString" "toLowerStdin" "Array.includes" "Array.forEach" "Misskey.serverInfo" "Misskey.i" "Misskey.meta" "sum" "ntest" "calcInt" "Misskey.makeJson" "Misskey.bindingBase" "Misskey.sendReq" "bool" "Misskey.myUserName" "Misskey.myName" "Misskey.myId" "Misskey.isAdmin" "unsetAllFunc" "getFuncList" "match" "removeMatchLine")
declare -r FSBLIB_VERSION='v0.2.5.1.r382.g7a671ac-lower'
