...
FSBLIB_FUNCLIST+=("Msg.common" "URL.authority" "Arch.getKernelFileList" "captureSpecialKeys" "Cache.exist" "readlinkf" "parseArg" "Sqlite3.call" "LibreTranslate.check" "Em.getAllPkgList" "choice" "addNewToArray" "Pm.checkPkg" "readlinkf_Posix" "SrcInfo.format" "Esc.clearLeft" "Msg.debug" "Csv.getClm" "Fsblib.envCheck" "arrayAppend" "choiceLoop" "readlinkf_Readlink" "Ini.getLastParam" "Awk.cos" "Cache.get" "URL.fragment" "Misskey.notes.Create" "Arch.getKernelSrcList" "Sqlite3.connect" "Array.append" "LibreTranslate.detect" "arrayIncludes" "selectMenu" "Pm.getConfig" "Em.getDefaultRepoName" "arrayIndex" "Esc.clearLine" "SrcInfo.getKeyList" "Msg.err" "Csv.getClmCnt" "Fsblib.fsblibEnvCheck" "Ini.getParam" "Awk.float" "Cache.getDir" "Array.fromStr" "Arch.getMkinitcpioPresetList" "URL.host" "Misskey.notes.Renotes" "getArrayIndex" "LibreTranslate.languages" "Sqlite3.create" "Pm.getInstalledPkgVer" "Em.getInstalledPkgList" "Esc.clearRight" "printArray" "SrcInfo.getPkgBase" "Csv.toBashArray" "Fsblib.requireLib" "Msg.info" "Awk.log" "printEvalArray" "LibreTranslate.translate" "Ini.getParamList" "Sqlite3.currentDb" "Cache.getFileLastUpdate" "Misskey.notes.Search" "Array.pop" "URL.noScheme" "Esc.clearScreen" "Pm.getKeyringList" "Em.getRepoConf" "revArray" "SrcInfo.getPkgName" "Msg.warn" "strToCharList" "LibreTranslate.translateAuto" "Cache.getID" "Array.push" "Awk.pi" "Sqlite3.delete" "Ini.getSectionList" "URL.path" "Pm.getLatestPkgVer" "Em.getRepoLocation" "Misskey.users.GetFrequentlyRepliedUsers" "SrcInfo.getSectionList" "Awk.print" "Cache.getTimeDiffFromLastUpdate" "Ini.parseLine" "Sqlite3.existField" "Array.remove" "Esc.moveCursor" "URL.pathAndQueryAndFragment" "fileType" "Pm.getName" "Em.getRepoPkgList" "getBaseName" "Misskey.users.Notes" "SrcInfo.getValue" "Esc.moveCursorDown" "Sqlite3.existTable" "getFileExt" "Array.rev" "Awk.rad" "URL.port" "Pm.getPacmanKernelPkg" "removeFileExt" "Em.getWorldPkgList" "Misskey.users.Pages" "SrcInfo.getValueInPkgBase" "Sqlite3.insert" "Cache.create" "Esc.moveCursorLeft" "Ini.newParam" "Awk.sin" "URL.query" "Array.shift" "Pm.getPacmanKeyringDir" "Cache.createDir" "SrcInfo.getValueInPkgName" "Misskey.users.SearchByUsernameAndHost" "Awk.tan" "checkFuncDefined" "Sqlite3.select" "Esc.moveCursorRight" "Pm.getRepoConf" "Ini.newSection" "URL.scheme" "forEach" "Em.noVersion" "SrcInfo.parse" "Misskey.users.Show" "Sqlite3.selectAll" "getLine" "Array.eval" "Esc.moveCursorUp" "Pm.getRepoListFromConf" "Ini.setValue" "URL.user" "isAvailable" "loop" "Pm.getRepoPkgList" "Array.last" "Misskey.users.Stats" "Esc.clearUpperLines" "Pm.getRepoServer" "breakChar" "Array.print" "URL.hasAuthority" "cutLastString" "Pm.getRepoVer" "Misskey.admin.ServerInfo" "getLastSplitString" "URL.hasFragment" "Esc.blackBackground" "isUUID" "Pm.getRoot" "printEval" "URL.hasPort" "Array.indexOf" "Esc.blackText" "randomString" "Pm.isRepoPkg" "Misskey.setup" "removeBlank" "URL.hasQuery" "Esc.blink" "Array.lastIndex" "textBox" "Pm.pacmanGpg" "toLower" "URL.hasUser" "Esc.blueBackground" "toLowerStdin" "Array.length" "Misskey.i" "Pm.run" "Esc.blueText" "calcInt" "Misskey.meta" "URL.parse" "Pm.runKey" "ntest" "Esc.bold" "Array.forEach" "sum" "Misskey.serverInfo" "Array.includes" "Esc.conceal" "URL.getQuery" "bool" "Pm.getDbNextSection" "Esc.crossedOut" "URL.parseQuery" "Pm.getDbSection" "getFuncList" "Misskey.bindingBase" "Esc.cyanBackground" "unsetAllFunc" "Misskey.makeJson" "Pm.getDbSectionList" "Esc.cyanText" "match" "Misskey.sendReq" "Esc.greenBackground" "removeMatchLine" "toArgs" "Pm.createDbTmpDir" "Esc.greenText" "Pm.deleteDbTmpDir" "Misskey.isAdmin" "Pm.getDbTmpDir" "Esc.italic" "Misskey.myId" "Pm.getPkgArch" "Misskey.myName" "Esc.lowIntensity" "Pm.getRepoListFromLocalDb" "Misskey.myUserName" "Esc.magentaBackground" "Pm.getSyncAllDesc" "Pm.getSyncDbDesc" "Esc.magentaText" "Pm.getSyncDbDescPath" "Esc.rapidBlink" "Esc.redBackground" "Pm.getVirtualPkgList" "Pm.isOpendSyncDb" "Esc.redText" "Pm.openSyncDb" "Esc.resetStyle" "Pm.openedSyncDbList" "Pm.parsePkgFileName" "Esc.reverse" "Esc.underline" "Esc.whiteBackground" "Esc.whiteText" "Esc.yellowBackground" "Esc.yellowText")
declare -r FSBLIB_VERSION='v0.2.6.r406.g7bb055d-lower'
