...
FSBLIB_FUNCLIST+=("Misskey.notes.Search" "choiceLoop" "Msg.common" "Msg.debug" "Msg.warn" "Misskey.notes.Create" "choice" "Arch.getKernelSrcList" "Arch.getKernelFileList" "Msg.info" "Arch.getMkinitcpioPresetList" "Misskey.notes.Renotes" "Msg.err" "Fsblib.envCheck" "Fsblib.requireLib" "Fsblib.fsblibEnvCheck" "Em.getAllPkgList" "Em.getDefaultRepoName" "Em.getInstalledPkgList" "Em.getRepoPkgList" "SrcInfo.format" "Em.getRepoLocation" "SrcInfo.getPkgName" "SrcInfo.getValueInPkgBase" "SrcInfo.getValueInPkgName" "SrcInfo.getSectionList" "SrcInfo.parse" "Em.getRepoConf" "SrcInfo.getKeyList" "SrcInfo.getPkgBase" "Em.getWorldPkgList" "SrcInfo.getValue" "Cache.getDir" "Cache.getFileLastUpdate" "Cache.getID" "Cache.getTimeDiffFromLastUpdate" "Cache.get" "Cache.exist" "Array.shift" "Array.pop" "Array.push" "Array.remove" "Array.append" "Array.rev" "Array.fromStr" "readlinkf" "readlinkf_Readlink" "readlinkf_Posix" "URL.authority" "URL.fragment" "URL.query" "URL.host" "URL.path" "URL.pathAndQueryAndFragment" "Csv.getClm" "Csv.getClmCnt" "Csv.toBashArray" "Sqlite3.insert" "addNewToArray" "arrayAppend" "Sqlite3.create" "arrayIncludes" "Sqlite3.currentDb" "arrayIndex" "Sqlite3.delete" "getArrayIndex" "Sqlite3.existField" "printArray" "Sqlite3.existTable" "revArray" "Sqlite3.selectAll" "strToCharList" "parseArg" "URL.user" "Sqlite3.call" "Sqlite3.connect" "URL.noScheme" "URL.scheme" "URL.port" "printEvalArray" "Sqlite3.select" "Awk.cos" "Awk.print" "Awk.rad" "Awk.log" "Awk.sin" "Awk.tan" "Awk.float" "Awk.pi" "Pm.getConfig" "Pm.getInstalledPkgVer" "Pm.getKeyringList" "Pm.getLatestPkgVer" "Pm.isRepoPkg" "Pm.run" "Pm.runKey" "Pm.getName" "Pm.getPacmanKernelPkg" "Pm.getPacmanKeyringDir" "Pm.getRepoListFromConf" "Pm.getRepoPkgList" "Pm.getRepoServer" "Pm.getRepoVer" "Pm.getRepoConf" "Pm.pacmanGpg" "Pm.checkPkg" "Pm.getRoot" "Ini.getLastParam" "Ini.getParam" "Ini.getSectionList" "Ini.parseLine" "Ini.getParamList" "Misskey.users.Notes" "Misskey.users.Pages" "Misskey.users.Stats" "Misskey.users.Show" "Misskey.users.SearchByUsernameAndHost" "Misskey.users.GetFrequentlyRepliedUsers" "Em.noVersion" "Cache.createDir" "Cache.create" "Array.eval" "Array.last" "Array.print" "URL.hasPort" "URL.hasAuthority" "URL.hasQuery" "fileType" "getFileExt" "removeFileExt" "getBaseName" "URL.hasFragment" "URL.hasUser" "Pm.getDbNextSection" "Pm.getDbSection" "Pm.getDbSectionList" "Ini.newParam" "Ini.newSection" "Ini.setValue" "Misskey.admin.ServerInfo" "Array.lastIndex" "Array.length" "Array.indexOf" "isAvailable" "checkFuncDefined" "forEach" "loop" "getLine" "URL.parse" "Pm.getSyncDbDescPath" "Pm.getDbTmpDir" "Pm.getVirtualPkgList" "Pm.getRepoListFromLocalDb" "Pm.openSyncDb" "Pm.getSyncAllDesc" "Pm.parsePkgFileName" "Pm.getPkgArch" "Pm.deleteDbTmpDir" "Pm.createDbTmpDir" "Pm.isOpendSyncDb" "Pm.getSyncDbDesc" "Pm.openedSyncDbList" "Misskey.setup" "Array.includes" "Array.forEach" "toLowerStdin" "toLower" "breakChar" "getLastSplitString" "isUUID" "removeBlank" "randomString" "cutLastString" "textBox" "printEval" "URL.getQuery" "URL.parseQuery" "Misskey.meta" "Misskey.serverInfo" "Misskey.i" "sum" "calcInt" "ntest" "Misskey.makeJson" "Misskey.sendReq" "Misskey.bindingBase" "bool" "Misskey.myName" "Misskey.myUserName" "Misskey.isAdmin" "Misskey.myId" "unsetAllFunc" "getFuncList" "removeMatchLine" "match")
declare -r FSBLIB_VERSION='v0.2.5.1.r426.g1ac8230-lower'
