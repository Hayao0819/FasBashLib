...
echo "------SrcInfo.Parse Line------"
PrintEvalArray SrcInfo | SrcInfo.Format | ForEach eval "SrcInfo.Parse Line <<< \"{}\""

echo "------SrcInfo.Parse  Key------"
PrintEvalArray SrcInfo | SrcInfo.Format | ForEach eval "SrcInfo.Parse Key <<< \"{}\""

echo "------SrcInfo.Parse Value------"
PrintEvalArray SrcInfo | SrcInfo.Format | ForEach eval "SrcInfo.Parse Value <<< \"{}\""
