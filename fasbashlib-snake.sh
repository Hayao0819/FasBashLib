...
FSBLIB_FUNCLIST+=("add_new_to_array" "array_append" "array_includes" "array_index" "get_array_index" "print_array" "print_eval_array" "rev_array" "str_to_char_list" "parse_arg" "em.get_all_pkg_list" "em.get_default_repo_name" "em.get_repo_conf" "csv.get_clm_cnt" "em.get_repo_pkg_list" "csv.to_bash_array" "em.get_world_pkg_list" "csv.get_clm" "em.get_installed_pkg_list" "em.get_repo_location" "url.fragment" "url.host" "url.no_scheme" "url.path_and_query_and_fragment" "url.port" "url.query" "url.scheme" "array.append" "url.user" "array.from_str" "array.pop" "url.path" "array.remove" "array.rev" "url.authority" "misskey.notes.renotes" "array.push" "array.shift" "misskey.notes.create" "misskey.notes.search" "cache.get_dir" "cache.exist" "cache.get_id" "cache.get_time_diff_from_last_update" "capture_special_keys" "choice" "choice_loop" "arch.get_mkinitcpio_preset_list" "arch.get_kernel_file_list" "arch.get_kernel_src_list" "cache.get" "cache.get_file_last_update" "msg.common" "msg.err" "msg.info" "msg.warn" "msg.debug" "libretranslate.check" "libretranslate.detect" "libretranslate.languages" "libretranslate.translate_auto" "libretranslate.translate" "pm.check_pkg" "pm.get_installed_pkg_ver" "pm.get_latest_pkg_ver" "pm.get_name" "pm.get_repo_list_from_conf" "pm.get_repo_pkg_list" "pm.get_pacman_keyring_dir" "pm.get_repo_server" "pm.get_repo_conf" "pm.get_repo_ver" "pm.get_root" "pm.is_repo_pkg" "pm.pacman_gpg" "pm.run_key" "srcinfo.get_key_list" "srcinfo.get_pkg_base" "srcinfo.get_section_list" "srcinfo.get_value" "srcinfo.get_value_in_pkg_base" "srcinfo.get_value_in_pkg_name" "pm.get_keyring_list" "srcinfo.parse" "sqlite3.call" "sqlite3.connect" "sqlite3.create" "sqlite3.exist_field" "sqlite3.exist_table" "sqlite3.insert" "srcinfo.format" "sqlite3.select" "sqlite3.select_all" "srcinfo.get_pkg_name" "ini.get_param" "ini.get_param_list" "sqlite3.current_db" "pm.get_pacman_kernel_pkg" "pm.run" "pm.get_config" "ini.get_section_list" "sqlite3.delete" "ini.parse_line" "readlinkf" "readlinkf__posix" "readlinkf__readlink" "esc.clear_left" "esc.clear_right" "esc.clear_screen" "esc.move_cursor" "esc.move_cursor_left" "esc.move_cursor_right" "esc.reset_style" "ini.get_last_param" "fsblib.env_check" "fsblib.fsblib_env_check" "fsblib.require_lib" "esc.clear_upper_lines" "esc.move_cursor_up" "esc.save_cursor" "esc.move_cursor_down" "esc.clear_line" "awk.cos" "awk.float" "awk.print" "awk.sin" "awk.rad" "awk.pi" "awk.log" "awk.tan" "file_type" "get_base_name" "get_file_ext" "remove_file_ext" "em.no_version" "misskey.users.get_frequently_replied_users" "misskey.users.pages" "misskey.users.show" "misskey.users.search_by_username_and_host" "misskey.users.stats" "misskey.users.notes" "url.has_user" "url.has_fragment" "array.print" "array.last" "array.eval" "url.has_query" "url.has_port" "url.has_authority" "cache.create" "cache.create_dir" "check_func_defined" "for_each" "get_line" "is_available" "loop" "pm.get_db_section" "pm.get_db_section_list" "pm.get_db_next_section" "ini.new_section" "ini.set_value" "ini.new_param" "cut_last_string" "is_uu_id" "print_eval" "text_box" "to_lower" "break_char" "to_lower_stdin" "random_string" "remove_blank" "get_last_split_string" "misskey.admin.server_info" "array.last_index" "array.index_of" "array.length" "url.parse" "pm.opened_sync_db_list" "pm.create_db_tmp_dir" "pm.parse_pkg_file_name" "pm.get_db_tmp_dir" "pm.get_pkg_arch" "pm.get_repo_list_from_local_db" "pm.get_virtual_pkg_list" "pm.get_sync_db_desc" "pm.is_opend_sync_db" "pm.delete_db_tmp_dir" "pm.get_sync_db_desc_path" "pm.get_sync_all_desc" "pm.open_sync_db" "calc_int" "ntest" "sum" "bool" "array.for_each" "array.includes" "misskey.setup" "url.get_query" "url.parse_query" "get_func_list" "unset_all_func" "misskey.i" "misskey.meta" "misskey.server_info" "match" "remove_match_line" "to_args" "misskey.send_req" "misskey.binding_base" "misskey.make_json" "misskey.my_user_name" "misskey.my_name" "misskey.my_id" "misskey.is_admin")
declare -r FSBLIB_VERSION='v0.2.6.r384.g964e537-snake'
