...
FSBLIB_FUNCLIST+=("msg.debug" "msg.common" "msg.warn" "msg.err" "msg.info" "url.authority" "url.fragment" "url.host" "url.no_scheme" "url.path" "url.path_and_query_and_fragment" "url.scheme" "url.query" "url.user" "srcinfo.format" "srcinfo.get_key_list" "srcinfo.get_pkg_name" "url.port" "srcinfo.get_value_in_pkg_base" "srcinfo.get_section_list" "srcinfo.parse" "arch.get_kernel_src_list" "arch.get_mkinitcpio_preset_list" "srcinfo.get_value" "srcinfo.get_pkg_base" "arch.get_kernel_file_list" "srcinfo.get_value_in_pkg_name" "readlinkf" "readlinkf__posix" "readlinkf__readlink" "capture_special_keys" "choice" "choice_loop" "csv.get_clm" "csv.get_clm_cnt" "pm.check_pkg" "pm.get_installed_pkg_ver" "pm.get_keyring_list" "pm.get_latest_pkg_ver" "pm.get_pacman_keyring_dir" "pm.get_repo_server" "pm.get_repo_conf" "pm.get_repo_pkg_list" "pm.get_root" "pm.is_repo_pkg" "pm.run" "pm.get_config" "parse_arg" "cache.exist" "cache.get" "cache.get_dir" "csv.to_bash_array" "cache.get_id" "pm.pacman_gpg" "pm.run_key" "em.get_all_pkg_list" "em.get_default_repo_name" "em.get_repo_conf" "em.get_repo_location" "em.get_world_pkg_list" "pm.get_name" "pm.get_repo_ver" "pm.get_repo_list_from_conf" "cache.get_time_diff_from_last_update" "pm.get_pacman_kernel_pkg" "cache.get_file_last_update" "sqlite3.call" "sqlite3.create" "sqlite3.current_db" "sqlite3.delete" "sqlite3.exist_field" "sqlite3.exist_table" "sqlite3.select" "em.get_installed_pkg_list" "em.get_repo_pkg_list" "sqlite3.select_all" "sqlite3.connect" "sqlite3.insert" "esc.clear_left" "esc.clear_line" "esc.clear_right" "esc.move_cursor_down" "esc.clear_screen" "esc.move_cursor_left" "esc.move_cursor_right" "esc.reset_style" "esc.save_cursor" "libretranslate.check" "libretranslate.detect" "libretranslate.languages" "libretranslate.translate" "libretranslate.translate_auto" "esc.move_cursor" "esc.move_cursor_up" "esc.clear_upper_lines" "fsblib.fsblib_env_check" "awk.float" "fsblib.require_lib" "awk.log" "awk.pi" "awk.sin" "awk.tan" "ini.get_param" "ini.get_param_list" "ini.get_section_list" "ini.parse_line" "fsblib.env_check" "awk.cos" "awk.print" "array_append" "array_includes" "array_index" "get_array_index" "print_array" "print_eval_array" "rev_array" "str_to_char_list" "add_new_to_array" "awk.rad" "ini.get_last_param" "array.append" "array.from_str" "array.pop" "array.push" "array.remove" "array.rev" "array.shift" "misskey.notes.create" "misskey.notes.renotes" "misskey.notes.search" "file_type" "get_base_name" "get_file_ext" "remove_file_ext" "url.has_authority" "url.has_fragment" "url.has_port" "url.has_user" "url.has_query" "cache.create" "cache.create_dir" "em.no_version" "pm.get_db_section_list" "pm.get_db_section" "pm.get_db_next_section" "ini.new_param" "ini.set_value" "ini.new_section" "array.last" "array.print" "array.eval" "is_available" "loop" "check_func_defined" "for_each" "get_line" "misskey.users.notes" "misskey.users.pages" "misskey.users.search_by_username_and_host" "misskey.users.show" "misskey.users.stats" "misskey.users.get_frequently_replied_users" "url.parse" "pm.get_virtual_pkg_list" "pm.delete_db_tmp_dir" "pm.get_db_tmp_dir" "pm.create_db_tmp_dir" "pm.get_pkg_arch" "pm.get_sync_db_desc" "pm.opened_sync_db_list" "pm.get_sync_all_desc" "pm.parse_pkg_file_name" "pm.get_repo_list_from_local_db" "pm.get_sync_db_desc_path" "break_char" "cut_last_string" "get_last_split_string" "is_uu_id" "print_eval" "random_string" "remove_blank" "to_lower_stdin" "to_lower" "text_box" "pm.open_sync_db" "pm.is_opend_sync_db" "array.last_index" "array.length" "array.index_of" "misskey.admin.server_info" "url.get_query" "url.parse_query" "calc_int" "ntest" "sum" "bool" "array.includes" "array.for_each" "misskey.setup" "get_func_list" "unset_all_func" "to_args" "remove_match_line" "match" "misskey.i" "misskey.meta" "misskey.server_info" "misskey.binding_base" "misskey.make_json" "misskey.send_req" "misskey.my_id" "misskey.my_name" "misskey.is_admin" "misskey.my_user_name")
declare -r FSBLIB_VERSION='v0.2.6.r387.gb305fe8-snake'
