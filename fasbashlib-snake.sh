...
FSBLIB_FUNCLIST+=("cache.get" "cache.exist" "cache.get_dir" "cache.get_file_last_update" "cache.get_id" "em.get_default_repo_name" "cache.get_time_diff_from_last_update" "em.get_installed_pkg_list" "em.get_repo_pkg_list" "em.get_world_pkg_list" "em.get_repo_conf" "em.get_repo_location" "array_append" "array_includes" "rev_array" "str_to_char_list" "em.get_all_pkg_list" "add_new_to_array" "url.fragment" "array_index" "url.host" "print_array" "url.no_scheme" "url.path" "url.path_and_query_and_fragment" "url.port" "url.query" "url.scheme" "url.user" "get_array_index" "url.authority" "print_eval_array" "sqlite3.select_all" "sqlite3.call" "sqlite3.connect" "sqlite3.create" "pm.check_pkg" "sqlite3.current_db" "pm.get_installed_pkg_ver" "sqlite3.exist_field" "pm.get_keyring_list" "sqlite3.exist_table" "pm.get_latest_pkg_ver" "sqlite3.insert" "pm.get_name" "sqlite3.delete" "pm.get_pacman_keyring_dir" "pm.get_repo_conf" "pm.get_repo_ver" "pm.get_repo_pkg_list" "arch.get_kernel_file_list" "pm.get_root" "arch.get_kernel_src_list" "arch.get_mkinitcpio_preset_list" "pm.is_repo_pkg" "pm.get_repo_list_from_conf" "pm.get_config" "pm.pacman_gpg" "pm.run" "srcinfo.format" "srcinfo.get_key_list" "srcinfo.get_pkg_base" "srcinfo.get_section_list" "pm.get_repo_server" "pm.get_pacman_kernel_pkg" "srcinfo.get_value" "srcinfo.get_value_in_pkg_base" "srcinfo.parse" "pm.run_key" "sqlite3.select" "srcinfo.get_value_in_pkg_name" "srcinfo.get_pkg_name" "readlinkf" "readlinkf__posix" "readlinkf__readlink" "ini.get_param" "ini.get_param_list" "ini.get_section_list" "ini.parse_line" "ini.get_last_param" "awk.log" "awk.print" "msg.warn" "msg.debug" "msg.err" "awk.sin" "choice" "msg.common" "choice_loop" "awk.pi" "msg.info" "awk.cos" "misskey.notes.create" "misskey.notes.search" "awk.rad" "awk.tan" "awk.float" "misskey.notes.renotes" "array.push" "array.shift" "parse_arg" "array.append" "array.from_str" "array.remove" "array.rev" "array.pop" "csv.get_clm" "csv.get_clm_cnt" "csv.to_bash_array" "fsblib.env_check" "fsblib.require_lib" "fsblib.fsblib_env_check" "cache.create_dir" "file_type" "cache.create" "get_base_name" "get_file_ext" "remove_file_ext" "pm.get_db_next_section" "pm.get_db_section" "url.has_authority" "pm.get_db_section_list" "url.has_fragment" "url.has_port" "url.has_user" "url.has_query" "em.no_version" "ini.new_param" "ini.new_section" "ini.set_value" "misskey.users.get_frequently_replied_users" "misskey.users.show" "misskey.users.pages" "misskey.users.stats" "misskey.users.search_by_username_and_host" "misskey.users.notes" "array.eval" "array.last" "array.print" "for_each" "get_line" "is_available" "loop" "check_func_defined" "pm.get_pkg_arch" "pm.get_repo_list_from_local_db" "pm.get_sync_all_desc" "pm.get_db_tmp_dir" "pm.delete_db_tmp_dir" "pm.open_sync_db" "pm.get_sync_db_desc_path" "url.parse" "pm.get_virtual_pkg_list" "pm.create_db_tmp_dir" "pm.opened_sync_db_list" "pm.parse_pkg_file_name" "pm.get_sync_db_desc" "pm.is_opend_sync_db" "misskey.admin.server_info" "array.length" "array.index_of" "array.last_index" "print_eval" "random_string" "remove_blank" "text_box" "get_last_split_string" "cut_last_string" "break_char" "to_lower" "is_uu_id" "to_lower_stdin" "url.get_query" "url.parse_query" "misskey.setup" "array.for_each" "array.includes" "ntest" "calc_int" "sum" "misskey.i" "misskey.meta" "bool" "misskey.server_info" "get_func_list" "unset_all_func" "misskey.send_req" "misskey.make_json" "misskey.binding_base" "remove_match_line" "match" "misskey.my_user_name" "misskey.my_id" "misskey.my_name" "misskey.is_admin")
declare -r FSBLIB_VERSION='v0.2.5.1.r426.g1ac8230-snake'
