...
FSBLIB_FUNCLIST+=("esc.clear_left" "esc.clear_line" "esc.clear_right" "esc.clear_screen" "cache.get_dir" "cache.get_file_last_update" "sqlite3.call" "sqlite3.connect" "cache.get" "sqlite3.current_db" "sqlite3.insert" "sqlite3.select" "cache.get_id" "sqlite3.select_all" "cache.get_time_diff_from_last_update" "sqlite3.create" "sqlite3.delete" "sqlite3.exist_field" "sqlite3.exist_table" "url.path" "capture_special_keys" "choice" "choice_loop" "select_menu" "url.user" "cache.exist" "url.path_and_query_and_fragment" "url.authority" "url.host" "readlinkf" "readlinkf__posix" "readlinkf__readlink" "url.scheme" "url.port" "awk.cos" "awk.float" "fsblib.env_check" "awk.pi" "fsblib.require_lib" "awk.print" "url.no_scheme" "awk.rad" "awk.tan" "awk.log" "awk.sin" "url.query" "url.fragment" "fsblib.fsblib_env_check" "arch.get_kernel_file_list" "arch.get_kernel_src_list" "arch.get_mkinitcpio_preset_list" "csv.get_clm" "csv.to_bash_array" "csv.get_clm_cnt" "libretranslate.translate_auto" "srcinfo.get_pkg_base" "ini.get_last_param" "ini.get_section_list" "libretranslate.detect" "libretranslate.check" "libretranslate.languages" "libretranslate.translate" "srcinfo.format" "srcinfo.get_key_list" "srcinfo.get_pkg_name" "ini.get_param_list" "ini.parse_line" "srcinfo.get_section_list" "pm.get_pacman_kernel_pkg" "pm.get_pacman_keyring_dir" "pm.get_repo_conf" "pm.get_repo_list_from_conf" "pm.get_repo_ver" "pm.get_root" "pm.is_repo_pkg" "pm.pacman_gpg" "pm.run" "srcinfo.parse" "pm.get_repo_pkg_list" "ini.get_param" "parse_arg" "array_append" "array_includes" "array_index" "srcinfo.get_value_in_pkg_base" "get_array_index" "srcinfo.get_value" "print_array" "print_eval_array" "rev_array" "str_to_char_list" "srcinfo.get_value_in_pkg_name" "pm.get_latest_pkg_ver" "pm.get_keyring_list" "pm.run_key" "pm.get_installed_pkg_ver" "add_new_to_array" "pm.check_pkg" "msg.debug" "msg.info" "msg.warn" "em.get_all_pkg_list" "em.get_default_repo_name" "em.get_world_pkg_list" "pm.get_repo_server" "em.get_repo_location" "em.get_installed_pkg_list" "em.get_repo_pkg_list" "pm.get_config" "msg.err" "pm.get_name" "msg.common" "misskey.notes.renotes" "misskey.notes.search" "misskey.notes.create" "array.pop" "array.push" "array.append" "array.from_str" "array.remove" "array.rev" "em.get_repo_conf" "array.shift" "esc.move_cursor_down" "esc.move_cursor_right" "esc.move_cursor_up" "esc.move_cursor" "esc.move_cursor_left" "file_type" "get_base_name" "get_file_ext" "remove_file_ext" "cache.create" "cache.create_dir" "url.has_authority" "url.has_fragment" "url.has_user" "url.has_port" "url.has_query" "em.no_version" "pm.get_db_next_section" "pm.get_db_section" "pm.get_db_section_list" "misskey.users.get_frequently_replied_users" "misskey.users.pages" "ini.new_section" "misskey.users.search_by_username_and_host" "misskey.users.show" "misskey.users.stats" "ini.new_param" "ini.set_value" "misskey.users.notes" "array.eval" "array.print" "array.last" "check_func_defined" "for_each" "get_line" "is_available" "loop" "esc.clear_upper_lines" "print_eval" "break_char" "cut_last_string" "get_last_split_string" "is_uu_id" "random_string" "remove_blank" "text_box" "to_lower" "to_lower_stdin" "url.parse" "pm.get_pkg_arch" "pm.get_sync_db_desc" "misskey.admin.server_info" "pm.get_virtual_pkg_list" "pm.is_opend_sync_db" "pm.open_sync_db" "array.index_of" "array.last_index" "pm.opened_sync_db_list" "array.length" "pm.delete_db_tmp_dir" "pm.create_db_tmp_dir" "pm.get_db_tmp_dir" "pm.get_repo_list_from_local_db" "pm.get_sync_all_desc" "pm.get_sync_db_desc_path" "pm.parse_pkg_file_name" "calc_int" "ntest" "sum" "esc.bold" "esc.cyan_text" "esc.green_text" "esc.red_background" "esc.reverse" "esc.underline" "esc.cyan_background" "esc.black_background" "esc.green_background" "esc.black_text" "esc.blue_text" "esc.blink" "esc.italic" "esc.rapid_blink" "esc.crossed_out" "esc.blue_background" "esc.magenta_text" "esc.magenta_background" "esc.yellow_background" "esc.low_intensity" "esc.red_text" "esc.reset_style" "esc.yellow_text" "esc.white_background" "esc.conceal" "esc.white_text" "url.parse_query" "url.get_query" "array.for_each" "array.includes" "bool" "misskey.setup" "get_func_list" "unset_all_func" "misskey.server_info" "misskey.i" "misskey.meta" "match" "remove_match_line" "to_args" "misskey.make_json" "misskey.send_req" "misskey.binding_base" "misskey.my_user_name" "misskey.my_name" "misskey.is_admin" "misskey.my_id")
declare -r FSBLIB_VERSION='v0.2.6.r396.geb4265b-snake'
