...
FSBLIB_FUNCLIST+=("awk.print" "awk.tan" "awk.float" "awk.log" "awk.pi" "awk.rad" "awk.cos" "awk.sin" "arch.get_mkinitcpio_preset_list" "arch.get_kernel_src_list" "arch.get_kernel_file_list" "url.path" "url.user" "url.scheme" "em.get_installed_pkg_list" "url.authority" "url.fragment" "url.host" "url.no_scheme" "url.path_and_query_and_fragment" "url.port" "em.get_all_pkg_list" "em.get_repo_conf" "em.get_repo_location" "em.get_repo_pkg_list" "url.query" "em.get_default_repo_name" "em.get_world_pkg_list" "choice" "choice_loop" "parse_arg" "str_to_char_list" "add_new_to_array" "array_append" "array_includes" "array_index" "get_array_index" "print_array" "print_eval_array" "rev_array" "msg.err" "msg.info" "ini.get_section_list" "array.append" "msg.common" "array.from_str" "array.pop" "msg.debug" "array.remove" "array.rev" "array.shift" "ini.get_last_param" "msg.warn" "ini.get_param_list" "fsblib.env_check" "fsblib.fsblib_env_check" "fsblib.require_lib" "array.push" "sqlite3.current_db" "sqlite3.delete" "sqlite3.call" "sqlite3.exist_table" "sqlite3.connect" "sqlite3.exist_field" "sqlite3.insert" "ini.parse_line" "sqlite3.select_all" "ini.get_param" "srcinfo.get_key_list" "sqlite3.create" "srcinfo.get_pkg_name" "srcinfo.get_value" "srcinfo.parse" "srcinfo.get_value_in_pkg_name" "sqlite3.select" "srcinfo.get_pkg_base" "srcinfo.format" "srcinfo.get_section_list" "srcinfo.get_value_in_pkg_base" "misskey.notes.renotes" "misskey.notes.create" "misskey.notes.search" "cache.exist" "cache.get" "cache.get_dir" "cache.get_id" "cache.get_time_diff_from_last_update" "cache.get_file_last_update" "csv.get_clm" "csv.get_clm_cnt" "csv.to_bash_array" "pm.get_repo_list_from_conf" "pm.get_repo_conf" "pm.get_config" "pm.get_installed_pkg_ver" "pm.get_keyring_list" "pm.get_latest_pkg_ver" "pm.get_pacman_keyring_dir" "pm.get_name" "readlinkf" "pm.run" "readlinkf__posix" "readlinkf__readlink" "pm.get_repo_pkg_list" "pm.get_repo_ver" "pm.is_repo_pkg" "pm.check_pkg" "pm.get_pacman_kernel_pkg" "pm.get_repo_server" "pm.run_key" "pm.get_root" "pm.pacman_gpg" "file_type" "get_base_name" "get_file_ext" "remove_file_ext" "em.no_version" "url.has_user" "url.has_authority" "url.has_query" "url.has_fragment" "url.has_port" "array.last" "array.print" "array.eval" "ini.new_section" "ini.new_param" "misskey.users.get_frequently_replied_users" "misskey.users.notes" "misskey.users.show" "misskey.users.search_by_username_and_host" "cache.create" "ini.set_value" "cache.create_dir" "misskey.users.pages" "misskey.users.stats" "for_each" "check_func_defined" "get_line" "is_available" "loop" "pm.get_db_next_section" "pm.get_db_section_list" "pm.get_db_section" "url.parse" "break_char" "cut_last_string" "get_last_split_string" "is_uu_id" "print_eval" "random_string" "to_lower" "remove_blank" "to_lower_stdin" "text_box" "array.last_index" "array.length" "array.index_of" "misskey.admin.server_info" "calc_int" "ntest" "pm.get_sync_db_desc" "sum" "pm.get_sync_db_desc_path" "pm.get_virtual_pkg_list" "pm.opened_sync_db_list" "pm.parse_pkg_file_name" "pm.is_opend_sync_db" "pm.create_db_tmp_dir" "pm.delete_db_tmp_dir" "pm.get_pkg_arch" "pm.get_db_tmp_dir" "pm.get_sync_all_desc" "pm.get_repo_list_from_local_db" "pm.open_sync_db" "url.get_query" "url.parse_query" "array.for_each" "array.includes" "misskey.setup" "bool" "get_func_list" "unset_all_func" "misskey.i" "misskey.server_info" "misskey.meta" "remove_match_line" "match" "misskey.send_req" "misskey.binding_base" "misskey.make_json" "misskey.my_name" "misskey.my_user_name" "misskey.my_id" "misskey.is_admin")
declare -r FSBLIB_VERSION='v0.2.5.1.r439.g37a8475-snake'
