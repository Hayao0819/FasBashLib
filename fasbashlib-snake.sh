...
FSBLIB_FUNCLIST+=("arch.get_kernel_file_list" "arch.get_kernel_src_list" "arch.get_mkinitcpio_preset_list" "array.append" "array.from_str" "array.pop" "array.push" "array.remove" "array.rev" "array.shift" "array.eval" "array.last" "array.print" "array.index_of" "array.last_index" "array.length" "array.for_each" "array.include" "array.includes" "awk.cos" "awk.float" "awk.log" "awk.pi" "awk.print" "awk.rad" "awk.sin" "awk.tan" "add_new_to_array" "array_append" "array_includes" "array_index" "get_array_index" "print_array" "print_eval_array" "rev_array" "str_to_char_list" "file_type" "get_base_name" "get_file_ext" "remove_file_ext" "check_func_defined" "for_each" "get_line" "is_available" "loop" "break_char" "cut_last_string" "get_last_split_string" "get_max_width" "is_uu_id" "print_eval" "random_string" "remove_blank" "text_box" "to_lower" "to_lower_stdin" "calc_int" "ntest" "sum" "bool" "get_func_list" "unset_all_func" "match" "remove_match_line" "to_args" "cache.exist" "cache.get" "cache.get_dir" "cache.get_file_last_update" "cache.get_id" "cache.get_time_diff_from_last_update" "cache.create" "cache.create_dir" "fsblib.env_check" "fsblib_env_check" "fsblib.require_lib" "csv.get_clm" "csv.get_clm_cnt" "csv.to_bash_array" "em.get_all_pkg_list" "em.get_default_repo_name" "em.get_installed_pkg_list" "em.get_repo_conf" "em.get_repo_location" "em.get_repo_pkg_list" "em.get_world_pkg_list" "em.no_version" "esc.clear_left" "esc.clear_line" "esc.clear_right" "esc.clear_screen" "esc.return" "esc.get_term_x" "esc.get_term_y" "esc.get_x" "esc.get_y" "esc.move_cursor" "esc.move_cursor_down" "esc.move_cursor_left" "esc.move_cursor_right" "esc.move_cursor_up" "esc.clear_line_and_return" "esc.clear_upper_lines" "esc.black_background" "esc.black_text" "esc.blink" "esc.blue_background" "esc.blue_text" "esc.bold" "esc.conceal" "esc.crossed_out" "esc.cyan_background" "esc.cyan_text" "esc.green_background" "esc.green_text" "esc.italic" "esc.low_intensity" "esc.magenta_background" "esc.magenta_text" "esc.rapid_blink" "esc.red_background" "esc.red_text" "esc.reset_style" "esc.reverse" "esc.underline" "esc.white_background" "esc.white_text" "esc.yellow_background" "esc.yellow_text" "ini.get_last_param" "ini.get_param" "ini.get_param_list" "ini.get_section_list" "ini.parse_line" "ini.new_param" "ini.new_section" "ini.set_value" "libretranslate.check" "libretranslate.detect" "libretranslate.languages" "libretranslate.translate" "libretranslate.translate_auto" "msg.common" "msg.debug" "msg.err" "msg.info" "msg.warn" "misskey.notes.create" "misskey.notes.renotes" "misskey.notes.search" "misskey.users.get_frequently_replied_users" "misskey.users.notes" "misskey.users.pages" "misskey.users.search_by_username_and_host" "misskey.users.show" "misskey.users.stats" "misskey.admin.server_info" "misskey.setup" "misskey.i" "misskey.meta" "misskey.server_info" "misskey.binding_base" "misskey.make_json" "misskey.send_req" "misskey.is_admin" "misskey.my_id" "misskey.my_name" "misskey.my_user_name" "pm.check_pkg" "pm.get_config" "pm.get_installed_pkg_ver" "pm.get_keyring_list" "pm.get_latest_pkg_ver" "pm.get_name" "pm.get_pacman_kernel_pkg" "pm.get_pacman_keyring_dir" "pm.get_repo_conf" "pm.get_repo_list_from_conf" "pm.get_repo_pkg_list" "pm.get_repo_server" "pm.get_repo_ver" "pm.get_root" "pm.is_repo_pkg" "pm.pacman_gpg" "pm.run" "pm.run_key" "pm.get_db_next_section" "pm.get_db_section" "pm.get_db_section_list" "pm.create_db_tmp_dir" "pm.delete_db_tmp_dir" "pm.get_db_tmp_dir" "pm.get_pkg_arch" "pm.get_repo_list_from_local_db" "pm.get_sync_all_desc" "pm.get_sync_db_desc" "pm.get_sync_db_desc_path" "pm.get_virtual_pkg_list" "pm.is_opend_sync_db" "pm.open_sync_db" "pm.opened_sync_db_list" "pm.parse_pkg_file_name" "parse_arg" "prog.bar" "prog.rotation" "prog.wide_bar" "capture_special_keys" "check_menu" "choice" "choice_loop" "select_menu" "readlinkf__posix" "readlinkf__readlink" "readlinkf.posix" "readlinkf.readlink" "readlinkf" "sqlite3.call" "sqlite3.connect" "sqlite3.create" "sqlite3.current_db" "sqlite3.delete" "sqlite3.exist_field" "sqlite3.exist_table" "sqlite3.insert" "sqlite3.select" "sqlite3.select_all" "srcinfo.format" "srcinfo.get_key_list" "srcinfo.get_pkg_base" "srcinfo.get_pkg_name" "srcinfo.get_section_list" "srcinfo.get_value" "srcinfo.get_value_in_pkg_base" "srcinfo.get_value_in_pkg_name" "srcinfo.parse" "url.authority" "url.fragment" "url.host" "url.no_scheme" "url.path" "url.path_and_query_and_fragment" "url.port" "url.query" "url.scheme" "url.user" "url.has_authority" "url.has_fragment" "url.has_port" "url.has_query" "url.has_user" "url.parse" "url.get_query" "url.parse_query")
FSBLIB_VERSION='v0.2.7.1.r430.gcfc0414-snake'
