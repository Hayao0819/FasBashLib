...
FSBLIB_FUNCLIST+=("sqlite3.connect" "sqlite3.create" "sqlite3.current_db" "sqlite3.exist_field" "sqlite3.exist_table" "sqlite3.select_all" "sqlite3.delete" "sqlite3.insert" "sqlite3.select" "msg.info" "sqlite3.call" "msg.debug" "msg.err" "msg.common" "msg.warn" "cache.get_file_last_update" "cache.exist" "cache.get_time_diff_from_last_update" "cache.get" "cache.get_id" "awk.cos" "awk.log" "awk.pi" "awk.print" "awk.rad" "cache.get_dir" "awk.sin" "awk.tan" "awk.float" "srcinfo.format" "srcinfo.get_key_list" "srcinfo.get_pkg_base" "srcinfo.get_pkg_name" "srcinfo.get_section_list" "srcinfo.get_value" "srcinfo.get_value_in_pkg_base" "srcinfo.parse" "arch.get_mkinitcpio_preset_list" "srcinfo.get_value_in_pkg_name" "arch.get_kernel_file_list" "arch.get_kernel_src_list" "csv.to_bash_array" "pm.check_pkg" "readlinkf" "pm.get_config" "pm.get_installed_pkg_ver" "readlinkf__readlink" "pm.get_keyring_list" "pm.get_latest_pkg_ver" "pm.get_pacman_keyring_dir" "pm.get_repo_pkg_list" "csv.get_clm_cnt" "pm.get_repo_ver" "pm.get_root" "pm.is_repo_pkg" "pm.run" "pm.run_key" "csv.get_clm" "readlinkf__posix" "pm.pacman_gpg" "pm.get_repo_server" "pm.get_repo_list_from_conf" "em.get_all_pkg_list" "ini.get_last_param" "em.get_installed_pkg_list" "ini.get_param_list" "em.get_repo_conf" "ini.get_section_list" "em.get_repo_pkg_list" "pm.get_name" "em.get_world_pkg_list" "pm.get_repo_conf" "ini.parse_line" "ini.get_param" "em.get_default_repo_name" "add_new_to_array" "array_append" "array_includes" "em.get_repo_location" "array_index" "str_to_char_list" "url.authority" "pm.get_pacman_kernel_pkg" "url.no_scheme" "url.path" "url.path_and_query_and_fragment" "url.query" "print_array" "print_eval_array" "url.user" "rev_array" "parse_arg" "url.port" "url.scheme" "url.fragment" "get_array_index" "url.host" "choice" "fsblib.env_check" "fsblib.fsblib_env_check" "fsblib.require_lib" "array.push" "array.remove" "array.append" "array.from_str" "array.rev" "array.shift" "misskey.notes.create" "misskey.notes.renotes" "array.pop" "misskey.notes.search" "cache.create" "cache.create_dir" "file_type" "get_base_name" "get_file_ext" "remove_file_ext" "url.has_port" "url.has_query" "url.has_user" "url.has_authority" "url.has_fragment" "pm.get_db_section" "em.no_version" "pm.get_db_section_list" "pm.get_db_next_section" "ini.new_section" "ini.set_value" "ini.new_param" "misskey.users.get_frequently_replied_users" "misskey.users.pages" "misskey.users.search_by_username_and_host" "misskey.users.show" "misskey.users.stats" "array.print" "misskey.users.notes" "array.last" "array.eval" "get_line" "check_func_defined" "for_each" "is_available" "loop" "pm.delete_db_tmp_dir" "pm.get_sync_db_desc_path" "url.parse" "pm.get_virtual_pkg_list" "pm.is_opend_sync_db" "pm.open_sync_db" "pm.get_repo_list_from_local_db" "pm.get_db_tmp_dir" "pm.opened_sync_db_list" "pm.create_db_tmp_dir" "pm.parse_pkg_file_name" "pm.get_sync_all_desc" "pm.get_sync_db_desc" "pm.get_pkg_arch" "misskey.admin.server_info" "array.index_of" "array.last_index" "array.length" "break_char" "is_uu_id" "print_eval" "cut_last_string" "random_string" "text_box" "to_lower_stdin" "get_last_split_string" "to_lower" "remove_blank" "url.get_query" "url.parse_query" "array.for_each" "misskey.setup" "array.includes" "calc_int" "ntest" "sum" "misskey.i" "misskey.server_info" "misskey.meta" "bool" "misskey.make_json" "misskey.send_req" "misskey.binding_base" "unset_all_func" "get_func_list" "remove_match_line" "match" "misskey.my_id" "misskey.my_user_name" "misskey.is_admin" "misskey.my_name")
declare -r FSBLIB_VERSION='v0.2.5.1.r407.g3897fb2-snake'
